...
-(void)animateTransition:(id<UIViewControllerContextTransitioning>)transitionContext {
    ...
    if (self.type == AnimationTypePresent) {
        //Add 'to' view to the hierarchy with 0.0 scale 插入“to”视图，初始缩放值为0.0
        toViewController.view.transform = CGAffineTransformMakeScale(0.0, 0.0);
        [containerView insertSubview:toViewController.view aboveSubview:fromViewController.view];
        
        //Scale the 'to' view to to its final position 缩放“to”视图为想要的效果
        ...
        //Scale the 'from' view down until it disappears 缩小“from”视图，直到其消失
        [UIView animateWithDuration:[self transitionDuration:transitionContext] animations:^{
